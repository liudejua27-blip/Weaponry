...
| R1 通用基础设施拆分 | 进行中 | connection、migration、object store、Repository/UoW、Job、Library、Creative Recast 与 Create Weapon Provider workflow 已提取；其余 generate/Patch/export 仍待迁移 |
