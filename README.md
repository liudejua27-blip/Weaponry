...
| R1 通用基础设施拆分 | 进行中 | connection、migration、object store、Repository/UoW、Job、Library、Creative Recast、Create Weapon 与 Generate-3D 同步/排队入口已提取；异步 worker 执行、Patch/export 仍待迁移 |
