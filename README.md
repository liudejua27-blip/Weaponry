...
| Module Pack 资产门 | `ModulePackManifest@1`、`ForgeCADModuleNaming@1`、目录/许可证/GLB/UV/材质/三角数/包围盒校验、dry-run、幂等批量导入、重启恢复已实现 | core/front01/front02 Blender authoring starter 已就绪；当前机器未安装 Blender，正式 10–12 个 GLB 仍需制作 |
