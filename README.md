...
| R1 通用基础设施拆分 | 进行中 | connection、migration、object store、Repository/UoW、Job、Library、Creative Recast、Create Weapon、Generate-3D 入口与 Worker Runtime 已提取；Patch 和 Unity export handler 仍待迁移 |
