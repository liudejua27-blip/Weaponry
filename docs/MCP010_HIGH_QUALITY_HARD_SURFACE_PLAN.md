...
当前合同面为 **404 个 JSON Schema**；MCP source surface 为 **91 read + 69 write = 160 tools**。CandidateAnimationVfxQuality@2 的 Runtime full 为 **354 passed / 0 failed / 22 ignored**（376 total），MCP full 为 **152 passed / 0 failed / 0 ignored**；真实 Attachment@3 + Quality@2 public full-chain positive fixture 仍 `NOT_RUN`。
