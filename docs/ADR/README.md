...
ADR-0026 于 2026-08-13 增补 Agentic Design Runtime 目标架构：在 ADR-0025 的 Runtime/MCP/Viewer 边界上，新增 DesignSession、SemanticSceneGraph、ReferenceCanvas、阶段质量门、Visual Evidence Bundle 和 Critic/Repair loop 的目标设计。它是后续高质量路线的规划，不改变当前 78 Schema、47 tools 或 MCP010F `QUALITY_TARGET_NOT_MET` 事实。
