...
> ADR-0030 是当前十天交付优先级与 Blender 内部原型边界的最新决策。它把首个 cohort 收缩为
> 穿越火线刀类，局部替代 0027/0028 的绝对 ForgeCAD-only/Blender-reference-only 限制；0025–0029
> 的 Runtime 单写者、typed boundary、证据、批准和历史保护继续有效。
...
ADR-0029 是当前产品方向权威：ForgeCAD Runtime lineage 产品化为 Weaponry，P0 只主攻由 Codex
生成高质量穿越火线武器；采用稳定拓扑、原子命令事务、Modifier/Evaluation Graph 和完整
game-ready/engine/human evidence chain。0025–0027 的单写者、typed、安全和证据边界继续有效，
其通用 MVP/原创武器范围被 0029 收紧。0028 已完全 superseded。
