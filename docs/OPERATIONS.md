...
2026-07-11 的真实样本运行使用 re-export core GLB，Blender 4.2.22 返回 `dcc_roundtrip_validated`，2178 顶点和 940 三角保持不变。这只证明单模块 starter 往返；发布前仍必须对工作台生成的不可变 combined GLB 重跑同一命令。
