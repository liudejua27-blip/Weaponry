...
证明 ForgeCAD 已具备把真实人工 Blender 工件从“技术 Pack 通过”推进到“可审计正式资产候选”的合同与只读门禁。当前机器已用 Blender 4.2.22 真实生成三模块 starter 和十模块 visual candidate；synthetic 正例仍只证明“所有条件满足时可通过”，真实 candidate 审阅草稿则用于证明“未人工批准时必须失败”。
