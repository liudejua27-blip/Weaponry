...
> 本文件是 2026-07-11 Weapon Concept P0 的历史就绪审计。ADR-0008 已将产品目标升级为通用机械概念 Agent；本文 C01–C10 不覆盖汽车、飞机、机械臂、完整外观、自动分件、ShapeProgram 或材质系统，不能作为新 G0–G8/C01–C12 的发布证据。
