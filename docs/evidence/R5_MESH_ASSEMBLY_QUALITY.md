...
- 本页记录当时的 `weapon-concept-geometry/1.1`；`1.2` 定位与间隙见 `R5_C07_LOCALIZATION.md`，当前 `1.3` 策略规则见 `R5_C07_POLICY_RULES.md`；
...
- 对称占位、隐藏几何、网格密度/预算与 P0 LOD0。

## 仍需发布证据

- 正式 Blender 资产 truth set、Tauri GPU/大资产性能；
