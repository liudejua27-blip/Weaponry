...
版本：2026-07-29
适用对象：组件、美术资产、缩略图和可选知识 Pack 作者

ADR-0022 后，资产作者可以面向任何合法非功能视觉对象准备参考、组件和材质；当前机器可编辑 Recipe/Connector/Joint 工具仍以机械资产为主。四个 Domain Pack 是兼容知识和回归集合，不是作者类别准入清单。角色、生物、植物或环境资产在 U004 前只能作为受检 GLB 参考或本地 deformable/local-hybrid 设计目标，不能伪装成当前可编辑 ShapeProgram。
