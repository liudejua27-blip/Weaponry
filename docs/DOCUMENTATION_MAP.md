...
2026-07-29 的 U001A 将 Markdown 从 105 份精简到 54 份；U004A 新增 ADR-0023 后当前树为 55 份，保留 12 份有效 ADR、3 份当前 evidence 文档和 0 份独立 legacy 手册。被取代的阶段报告、旧操作说明和重复决策由 Git 历史保存，不再与当前产品文档并列。
...
| 产品/设计 | [PRODUCT_DEFINITION](PRODUCT_DEFINITION.md)、[AGENT_CURRENT_ISSUES_AUDIT](AGENT_CURRENT_ISSUES_AUDIT.md) | [DESIGN](DESIGN.md)、[FRONTEND](FRONTEND.md) |
...
| Codex/Luna | [AGENTS](../AGENTS.md)、[DOCUMENTATION_STATUS](DOCUMENTATION_STATUS.md)、[CODEX_HANDOFF](CODEX_HANDOFF.md) | [CODEX_EXECUTION_PLAN](CODEX_EXECUTION_PLAN.md)、[CODEX_TASK_INDEX](CODEX_TASK_INDEX.md)、[LUNA_GOAL_EXECUTION_GUIDE](LUNA_GOAL_EXECUTION_GUIDE.md) |
