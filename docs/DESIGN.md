...
当前已实现 `ConceptExportManifest@1` 源包与 `Model/combined.glb`：ZIP 中包含不可变模块 GLB、WeaponConceptSpec、ModuleGraph、可选最新质量报告、README、组合模型和逐文件 SHA-256；数据库保存 package asset、artifact link 与 completed JobEvent。
