...
已完成第一切片：索引、三角形数量、退化面、法线、UV0、开放/非流形边、清单 bounds、Connector `0.1 mm / 0.1°` 对齐，以及未直连组件 AABB 穿插筛查。当前 AABB Finding 是快速复核提示，不等价于精确三角相交；隐藏几何、密度、对称、LOD 和 Finding 点击定位仍待实现。
