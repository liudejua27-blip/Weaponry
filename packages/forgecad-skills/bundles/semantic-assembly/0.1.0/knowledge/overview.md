...
First-party declarative Skill `semantic-assembly@0.1.0`. It declares typed inputs, a bounded Recipe and product-owned validators; it does not contain executable code.
