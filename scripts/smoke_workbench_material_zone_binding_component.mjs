...
const output = await mkdtemp(join(tmpdir(), 'forgecad-m105-material-zone-'))
...
try {
  ...
  module.runMaterialZoneBindingSmoke()
  console.log('M105 material zone binding component smoke passed')
} finally {
