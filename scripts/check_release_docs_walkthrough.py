...
def main() -> int:
    required = [
        ...
        "docs/ADR/0026-agentic-design-runtime.md",
        "docs/FORGECAD_AGENTIC_DESIGN_RUNTIME_PLAN.md",
        "docs/ARCHITECTURE_MODULE_BOUNDARY.md",
        "docs/DEPRECATED_ISOLATION_PLAN.md",
