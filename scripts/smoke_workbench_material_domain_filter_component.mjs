...
const output = await mkdtemp(join(tmpdir(), 'forgecad-m106-material-domain-'))
...
try {
  const result = spawnSync(
    ...
    [
      ...
      '--allowSyntheticDefaultImports', '--outDir', output, '--rootDir', DESKTOP_SOURCE,
  ...
  module.runMaterialDomainFilterSmoke()
  console.log('M106 material domain filter component smoke passed')
} finally {
