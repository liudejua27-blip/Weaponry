...
from packaged_sidecar_preflight import DEFAULT_CONTRACT, ROOT, preflight


def main() -> int:
    blocked = preflight(DEFAULT_CONTRACT, ROOT)
    _assert(blocked["status"] == "blocked_missing_sidecar", "empty checked-in sidecar must be reported as missing")
