...
fn build_view_evidence(
    ...
    Some(json!({
        ...
        "camera_canonical_sha256":view.get("camera_claim").and_then(|claim| claim.get("camera_canonical_sha256")).cloned().unwrap_or(Value::Null),
        "view_spec_sha256":view.get("view_spec").and_then(|spec| spec.get("canonical_sha256")).cloned().unwrap_or(Value::Null),
        "target_sha256":view.get("target_sha256").cloned().unwrap_or(Value::Null),
        "mask_sha256":view.get("mask_sha256").cloned().unwrap_or(Value::Null),
