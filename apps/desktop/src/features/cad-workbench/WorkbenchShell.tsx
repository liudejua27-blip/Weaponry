...
import {
  hasVisibleWorkbenchError,
  shouldShowWorkbenchHistory,
  workbenchLayoutClassName,
...
export function WorkbenchShell() {
  ...
  const hasActiveModeError = hasVisibleWorkbenchError(
    latestAgentRequestId,
    concept.error,
    activeDesignState.error?.message,
  )
  ...
  const showWorkbenchHistory = shouldShowWorkbenchHistory({
    hasAgentAsset: Boolean(activeAgentAssetVersion),
    hasCandidateResult: Boolean(visibleSingleResult || agentBlockoutSegmentation),
  ...
  return (
    ...
    >
      ...
      <div
        className={`${workbenchLayoutClassName({
          dockState: viewportDock.dockState,
          compact: isMobileLayout,
          sidebarOpen: isMobileSidebarOpen,
          assistantOpen: isMobileAssistantOpen,
          sidebarCollapsed: isSidebarCollapsed,
          assistantCollapsed: isAssistantCollapsed,
          showHistory: showWorkbenchHistory,
      ...
      >
        ...
        <main className="f026-conversation-stage" aria-label="AI 设计助手工作区">
          ...
          <section className="f026-agent-timeline">
            ...
            <AgentConversation
              ...
              errorMessage={latestAgentRequestId > 0 ? concept.error : null}
              compatibilityDecisionRejected={latestAgentRequestId > 0 && singleResultDecisionPresentation.presentation.state === 'failed'}
        ...
        {showWorkbenchHistory ? <CadWorkbenchPanelStatusBar
